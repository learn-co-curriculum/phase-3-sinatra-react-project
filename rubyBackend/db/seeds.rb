...
language = ["python","javascript","ruby","go","react","typescript","SQL","angular","java","pascal","C++"]
 ...
 25.times do 
    Job.create(
        company_name: Faker::Company.unique.name, job_title: Faker::Job.unique.title,location:Faker::Address.unique.city,employment_type:Faker::Job.employment_type,work_site:work_site.sample,job_url:Faker::Internet.unique.domain_name,salary:Faker::Number.unique.between(from: 45000, to: 150000) 
    )
end
