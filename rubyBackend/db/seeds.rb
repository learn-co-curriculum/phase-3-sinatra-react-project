...
language = ["python","javascript","ruby","go","react","typescript","SQL","angular","java","pascal","C++"]
 ...
 100.times do 
    Job.create(
        company_name: Faker::Company.name, job_title: Faker::Job.title,application_date:futureDay , follow_up_date:(futureDay + 14),location:Faker::Address.city,employment_type:Faker::Job.employment_type,work_site:work_site.sample,job_url:Faker::Internet.domain_name,salary:Faker::Number.between(from: 45000, to: 150000) 
    )
end
