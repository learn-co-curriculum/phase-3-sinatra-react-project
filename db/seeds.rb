puts "🌱 Seeding spices..."
u1 = User.create(username: "Alexis Torosina", image_url:"http://www.stickpng.com/img/icons-logos-emojis/users/young-user-icon", followers: 15, following: 126, password: "123")
u2 = User.create(username: "Taylan Postalci", image_url:"http://www.stickpng.com/img/icons-logos-emojis/users/young-user-icon", followers: 78, following: 5, password: "123")
