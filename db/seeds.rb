...
MenuItem.create(course: "Dinner", name: "Chiken Parmesan", price: 14.99, image_url: "https://preppykitchen.com/wp-content/uploads/2018/10/Chicken-Parmesan-Recipe-n.jpg", restaurant_id: sinatras_finest.id)
...
MenuItem.create(course: "Desert", name: "Tiramisu", price: 12.99, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSPHX_X_ZuFFSw53A6rDu0q2NEeEmeTwa5slQ&usqp=CAU", restaurant_id: sinatras_finest.id)
MenuItem.create(course: "Desert", name: "Maritozzo", price: 12.99, image_url: "https://c8.alamy.com/comp/2FJRXWC/homemade-maritozzo-is-italian-roman-breakfast-sweet-that-whipped-cream-sandwiched-between-brioche-2FJRXWC.jpg", restaurant_id: sinatras_finest.id)
MenuItem.create(course: "Desert", name: "Cannoli", price: 9.99, image_url: "https://www.cookingclassy.com/wp-content/uploads/2020/02/cannoli-20.jpg", restaurant_id: sinatras_finest.id)
MenuItem.create(course: "Desert", name: "Panettone", price: 8.99, image_url: "https://www.cento.com/images/articles/panettone_pandoro/panettone_featured.jpg", restaurant_id: sinatras_finest.id)

MenuItem.create(course: "Lunch", name: "Caprese Salad", price: 9.99, image_url: "https://emilybites.com/wp-content/uploads/2020/08/Caprese-Salad-7b.jpg", restaurant_id: sinatras_finest.id)
MenuItem.create(course: "Lunch", name: "Beef and Barley Soup", price: 13.99, image_url: "https://thecozyapron.com/wp-content/uploads/2018/09/beef-barley-soup_thecozyapron_1.jpg", restaurant_id: sinatras_finest.id)
MenuItem.create(course: "Lunch", name: "Deep-fried Courgette Flowers", price: 12.99, image_url: "https://www.nonnabox.com/wp-content/uploads/Fried_Zucchini_Blossoms_Recipe_Fiori_di_Zucca.jpg", restaurant_id: sinatras_finest.id)
MenuItem.create(course: "Lunch", name: "Parmesan Hero", price: 17.99, image_url: "https://static.wikia.nocookie.net/spongebob/images/2/27/Unreal_Estate_113.png/revision/latest?cb=20170604214809", restaurant_id: sinatras_finest.id)
MenuItem.create(course: "Lunch", name: "Acciughe al Verde", price: 13.99, image_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcTx-g9wqORuTA6YS8_4bwbvUsCEurRUuZ0mXg&usqp=CAU", restaurant_id: sinatras_finest.id)
