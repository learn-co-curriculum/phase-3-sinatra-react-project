...
g4 = Genre.create(title: "Alternative", favorite: false, top3: false)
...
s4 = Song.create(artist_id: a4.id, genre_id: g3.id, song_title: "First Class", release_date: "April 8, 2022")
