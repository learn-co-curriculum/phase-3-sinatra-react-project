...
app1 = Application.create(company: "Meta", position: "Software Enginner 2", status: "pending", user_id: user1.id, favorite: false, logo_url: "https://static.dezeen.com/uploads/2021/11/meta-facebook-rebranding-name-news_dezeen_2364_col_sq-213x213.jpg")
app2 = Application.create(company: "IBM", position: "Associate Software Enginner", status: "offer made", user_id: user1.id, favorite: false, logo_url: "https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcSZlxf_-ydMMfjIV_gDe0-mkbOwmS9W8FWMxx5n76I6lNd_fh_F7dGWFPxihZYbZGYFSLI&usqp=CAU")
app3 = Application.create(company: "Amazon", position: "Software Enginner", status: "rejected", user_id: user1.id, favorite: false, logo_url: "https://www.freeiconspng.com/uploads/amazon-icon-6.png")
