...
Customer.create(name: Faker::Name.name, email: Faker::Internet.email, id: 1)
Customer.create(name: Faker::Name.name, email: Faker::Internet.email, id: 2)
Customer.create(name: Faker::Name.name, email: Faker::Internet.email, id: 3)
Customer.create(name: Faker::Name.name, email: Faker::Internet.email, id: 4)
Customer.create(name: Faker::Name.name, email: Faker::Internet.email, id: 5)
Customer.create(name: Faker::Name.name, email: Faker::Internet.email, id: 6)
Customer.create(name: Faker::Name.name, email: Faker::Internet.email, id: 7)
Customer.create(name: Faker::Name.name, email: Faker::Internet.email, id: 8)
