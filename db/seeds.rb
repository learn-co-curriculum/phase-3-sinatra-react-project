...
#Songs
s_footsteps = Song.create(title: "Footsteps in the Dark", album_id: guns.id , artist_id: isley.id, genre: "soul", youtube_link: "https://www.youtube.com/watch?v=Dyq9zlYMw9g&ab_channel=TheIsleyBrothers-Topic", duration: 306)
...
s_strawberry = Song.create(title: "Strawberry Fields Forever", album_id: strawberry.id , artist_id: beatles.id , genre: "rock", youtube_link: "https://www.youtube.com/watch?v=HtUH9z_Oey8&ab_channel=TheBeatlesVEVO", duration: 263)
s_red = Song.create(title: "Dark Red", album_id: red.id , artist_id: steve.id , genre: "indie", youtube_link: "https://www.youtube.com/watch?v=L0wusEVceek&ab_channel=SteveLacy-Topic", duration: 173)
#Albums
...
guns = Album.create(title: "Go For Your Guns", release_date: "1977", downloads: 25354, duration: 2005)
strawberry = Album.create(title: "Strawberry Fields Forever / Penny Lane", release_date: "1967", downloads: 2532154, duration: 449)
demo = Album.create(title: "Steve Lacy Demo", release_date: "2017", downloads: 233254, duration: 813)
