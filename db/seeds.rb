...
Zookeeper.create(name: "Jessie Lee", image: 'https://spng.pngfind.com/pngs/s/55-557834_potato-spud-hd-png-download.png')
...
Animal.create(name: "Gretchen", image:'https://api.time.com/wp-content/uploads/2015/02/panda-cub.jpg', birthdate: 'February 22, 2019',sex: "F", species: "Panda")
Animal.create(name: "Tommy", image:'https://30txqa38zb7h2db3bbcpzb1x-wpengine.netdna-ssl.com/wp-content/uploads/2018/12/Crocodylus-niloticus.jpg', birthdate: 'December 12, 2020',sex: "M", species: "Crocodile")
