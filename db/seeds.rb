...
Restaurant.create(
    ...
    tag: "Bowls",
    logo_url: "https://play-lh.googleusercontent.com/p3BSzfGRMU-HfxFH6V7Qb_abjyOzBSJlPkfKghnJgqXHF7FzJb2heotot1uP7h0Gvr0=w240-h480-rw",
...
RestaurantRequest.create(name: "Birdcall", location: "Denver, CO", upvotes: 0, downvotes: 0)
RestaurantRequest.create(name: "Panera", location: "Denver, CO", upvotes: 0, downvotes: 0)
RestaurantRequest.create(name: "Snarf's Sandwiches", location: "Denver, CO", upvotes: 0, downvotes: 0)
