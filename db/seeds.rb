...
d1 = Destination.create(name: "Home of Ohio Meth Labs ", location: "Waverly, OH", description: "Be careful out there, it’s icy here all year around! ", image: "https://abandonedonline.net/wp-content/uploads/2021/12/20211113-DJI_0756-Edit.jpg", likes: 20)
...
d3 = Destination.create(name: "Just Drive Through This Part", location: "Medford, OR", description: "Do you want to breathe clean air? Don't come here!", image: "https://files.ondemandhosting.info/imagecache/cropfit@w=710/blob/images/articles/7/d/7d50ea49-0fb8-11e9-baed-42010a8001f9/medford-oregon.jpg?_=5ksxC0lT", likes: 13)
d4 = Destination.create(name: "Like Watching Paint Dry", location: "Englewood, KY", description: "There’s just nothing to do there. At all. ", image: "https://mediavault.point2.com/p2h/listing/2bd6/baa6/d68e/82b05444878726eb9a02/nwm_large.jpg", likes: 55)
d5 = Destination.create(name: "Some Town in TN", location: "Forest Hills, TN", description: "Just dont go if you wanna stay awake", image: "https://www.cityofforesthills.com/sites/default/files/imageattachments/parks/page/117/a1176_e.jpg", likes: 33)
d6 = Destination.create(name: "Teachers Here Have Guns", location: "Jacksonville, NC", description: "The finest strip malls in all of North Carolina", image: "https://i.pinimg.com/originals/a7/50/05/a75005e5bcee292725dbefeb05106bec.jpg", likes: 12)
