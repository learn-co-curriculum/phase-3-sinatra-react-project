...
MenuItem.create(course: "desert", name: "Gelato", ingredients: Faker::Food.ingredient, price: 9, image_url: "https://images.media-allrecipes.com/userphotos/6732586.jpg", restaurant_id: sinatras_finest.id)
MenuItem.create(course: "dinner", name: "Pesto alla Genovese", ingredients: Faker::Food.ingredient, price: 17.99, image_url: "https://assets.tmecosys.com/image/upload/t_web767x639/img/recipe/ras/Assets/0802C73C-3213-4AA6-BD3E-7390A13989FF/Derivates/ff280a78-bfae-46c9-9ea8-c63f5508cde8.jpg", restaurant_id: sinatras_finest.id)
MenuItem.create(course: "dinner", name: "Lasagne", ingredients: Faker::Food.ingredient, price: 19, image_url: "https://3f4c2184e060ce99111b-f8c0985c8cb63a71df5cb7fd729edcab.ssl.cf2.rackcdn.com/media/19227/classiclasagna.jpg", restaurant_id: sinatras_finest.id)
MenuItem.create(course: "dinner", name: "Prosciutto di Parma", ingredients: Faker::Food.ingredient, price: 22.99, image_url: "https://www.delibusiness.com/wp-content/uploads/2021/11/AdobeStock_327766584-scaled.jpg", restaurant_id: sinatras_finest.id)
